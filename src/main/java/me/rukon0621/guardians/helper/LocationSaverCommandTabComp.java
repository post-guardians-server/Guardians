...
public class LocationSaverCommandTabComp implements TabCompleter {
    private static List<String> argument0 = new ArrayList<>();

    //"설정", "삭제", "지급", "목록"
    public LocationSaverCommandTabComp() {
        argument0.add("설정");
        argument0.add("삭제");
        argument0.add("이동");
        argument0.add("지급");
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String str, @NotNull String[] args) {
        ...
        return TabCompleteUtils.searchAtSet(LocationSaver.locationData.keySet(), args[1]);
    }
}
