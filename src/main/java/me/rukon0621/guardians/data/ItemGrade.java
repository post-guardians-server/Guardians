...
public enum ItemGrade {
    UNKNOWN(301, "알 수 없음", "&7", "&7알 수 없음", 0, "\uE01A", 1),
    NORMAL(301, "일반", "&f", "&f일반",1, "\uE01A", 1),
    UNCOMMON(302, "언커먼", "#94ef98", "#94ef98언커먼",2, "\uE01B", 2),
    UNIQUE(303, "유니크", "#ffd966", "#ffd966유니크",3, "\uE01C", 3),
    EPIC(304, "에픽", "#ba95e5", "#ba95e5에픽",4, "\uE01D", 4),
    LEGEND(305, "레전드", "#fd7c47", "#fd9961레#fd7c47전#fd5e2c드",5, "\uE01E", 5),
    ANCIENT(306, "에이션트", "#ff67af", "#ffaee8에#ff8acb이#ff67af션#ff4392트",6, "\uE01F", 6);
    ...
    ItemGrade(int customModelData, String str, String color , String coloredStr, int level, String stoneUnicode, int stoneMaxSlots) {
