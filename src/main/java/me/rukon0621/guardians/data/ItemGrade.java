...
public enum ItemGrade {
    ...
    NORMAL(301, "일반", "&f", "&f일반",1, "\uE01A", 1, 65),
    UNCOMMON(302, "언커먼", "#94ef98", "#94ef98언커먼",2, "\uE01B", 2, 25),
    UNIQUE(303, "유니크", "#ffd966", "#ffd966유니크",3, "\uE01C", 3, 9),
    EPIC(304, "에픽", "#ba95e5", "#ba95e5에픽",4, "\uE01D", 4, 0.9),
    LEGEND(305, "레전드", "#fd7c47", "#fd9961레#fd7c47전#fd5e2c드",5, "\uE01E", 5, 0.09),
